...
<!-- badges: end -->
 ...
 `presentifyr` is a Shiny application that builds PowerPoint presentations from                                                                                                                               
  R-generated figures. Select images from your project, choose a slide layout from                                                                                                                             
  your own template, configure footnote styling, and generate a `.pptx` in a matter of seconds. 
  When figures or footnotes change between review rounds, sync and rebuild the deck with a click of a button.  
